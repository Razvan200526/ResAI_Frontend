...
import { useResumeChatStore } from './resumeStore';
...
export const ResumeChat = ({ resume }: { resume: ResumeType }) => {
  ...
  const { setData: setStoredResume } = useResumeChatStore(resume.id);
  ...
  return (
    <>
      ...
      >
        <nav className="px-4 py-2 rounded sticky top-0 z-10 bg-light flex items-center justify-between border-b border-resume/20 shrink-0">
          <div className="flex-col items-center">
            <H6 className="text-resume truncate">
              {resume.name.split('.')[0]}
            </H6>
                            ...
                            >
                              {role === 'user' ? (
                                ...
                                <ReactMarkdown
                                  ...
                                  components={{
                                    h1: ({ children }) => (
                                      <H1 className="text-xl font-semibold text-secondary-text mt-4 mb-2">
                                        {children}
                                      </H1>
                                    ),
                                    h2: ({ children }) => (
                                      <H2 className="text-lg font-semibold text-secondary-text mt-3 mb-2">
                                        {children}
                                      </H2>
                                    ),
                                    h3: ({ children }) => (
                                      <H3 className="text-base text-secondary-text font-semibold mt-2 mb-1">
                                        {children}
                                      </H3>
                                    ),
                                    p: ({ children }) => (
